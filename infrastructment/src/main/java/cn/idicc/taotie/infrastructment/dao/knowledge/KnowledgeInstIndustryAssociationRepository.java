...
@Slf4j
@Service
public class KnowledgeInstIndustryAssociationRepository {

	private static final String ES_NAME = "knowledge_inst_industry_association";
	...
	public void saveAll(List<KnowledgeInstIndustryAssociationPO> list) {
