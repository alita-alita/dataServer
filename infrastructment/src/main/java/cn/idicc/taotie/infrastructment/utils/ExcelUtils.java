...
public class ExcelUtils {
        ...
        public static JSONArray readFile(String fileName,InputStream stream) throws Exception {
            return readExcel(fileName, stream);
        }
        ...
        private static JSONArray readExcel(String fileName,InputStream stream) throws IOException {
            Workbook book = getWorkbook(fileName, stream);
            if (book == null) {
                return new JSONArray();
            }
            JSONArray array = readSheet(book.getSheetAt(0));
    ...
    private static Workbook getWorkbook(MultipartFile mFile, File file) throws IOException {
        ...
        public static void export(HttpServletResponse response, File file, String fileName,
